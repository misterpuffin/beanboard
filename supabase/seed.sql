...
-- Schedule entries (week of 12 May 2026)
-- Joey on Cooltech audit (pr7) Mon-Fri + GBS audit (pr1) Thu-Fri
insert into schedule_entries (profile_id, project_id, date) values
  ('c1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000007', '2026-05-12'),
  ('c1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000007', '2026-05-13'),
  ('c1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000007', '2026-05-14'),
  ('c1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000007', '2026-05-15'),
  ('c1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000007', '2026-05-16'),
  ('c1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000001', '2026-05-15'),
  ('c1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000001', '2026-05-16');

-- HC on ADCT audit (pr4) Mon-Thu
insert into schedule_entries (profile_id, project_id, date) values
  ('c1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000004', '2026-05-12'),
  ('c1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000004', '2026-05-13'),
  ('c1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000004', '2026-05-14'),
  ('c1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000004', '2026-05-15');

-- Malar on ADCT audit (pr4) Mon-Wed
insert into schedule_entries (profile_id, project_id, date) values
  ('c1000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000004', '2026-05-12'),
  ('c1000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000004', '2026-05-13'),
  ('c1000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000004', '2026-05-14');

-- Zareen on Noah's Ark audit (pr2) Tue-Thu
insert into schedule_entries (profile_id, project_id, date) values
  ('c1000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000002', '2026-05-13'),
  ('c1000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000002', '2026-05-14'),
  ('c1000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000002', '2026-05-15');

-- Jestinna on Aldon audit (pr5) Mon-Fri
insert into schedule_entries (profile_id, project_id, date) values
  ('c1000000-0000-0000-0000-000000000009', 'e1000000-0000-0000-0000-000000000005', '2026-05-12'),
  ('c1000000-0000-0000-0000-000000000009', 'e1000000-0000-0000-0000-000000000005', '2026-05-13'),
  ('c1000000-0000-0000-0000-000000000009', 'e1000000-0000-0000-0000-000000000005', '2026-05-14'),
  ('c1000000-0000-0000-0000-000000000009', 'e1000000-0000-0000-0000-000000000005', '2026-05-15'),
  ('c1000000-0000-0000-0000-000000000009', 'e1000000-0000-0000-0000-000000000005', '2026-05-16');

-- Yani on JD Pacific accounts (pr6) Mon-Wed + Cooltech GST (pr18) Thu-Fri
insert into schedule_entries (profile_id, project_id, date) values
  ('c1000000-0000-0000-0000-000000000010', 'e1000000-0000-0000-0000-000000000006', '2026-05-12'),
  ('c1000000-0000-0000-0000-000000000010', 'e1000000-0000-0000-0000-000000000006', '2026-05-13'),
  ('c1000000-0000-0000-0000-000000000010', 'e1000000-0000-0000-0000-000000000006', '2026-05-14'),
  ('c1000000-0000-0000-0000-000000000010', 'e1000000-0000-0000-0000-000000000018', '2026-05-15'),
  ('c1000000-0000-0000-0000-000000000010', 'e1000000-0000-0000-0000-000000000018', '2026-05-16');

-- John on Bethesda audit (pr3) Mon-Tue + Family of Grace audit (pr9) Wed-Fri
insert into schedule_entries (profile_id, project_id, date) values
  ('c1000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000003', '2026-05-12'),
  ('c1000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000003', '2026-05-13'),
  ('c1000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000009', '2026-05-14'),
  ('c1000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000009', '2026-05-15'),
  ('c1000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000009', '2026-05-16');

-- Charlotte on Cooltech audit (pr7) Mon-Wed
insert into schedule_entries (profile_id, project_id, date) values
